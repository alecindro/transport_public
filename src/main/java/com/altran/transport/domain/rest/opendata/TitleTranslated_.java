...
public class TitleTranslated_ implements Serializable
{
    ...
    private final static long serialVersionUID = -7476517671052054119L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TitleTranslated_ other = (TitleTranslated_) obj;
		if (ca == null) {
			if (other.ca != null)
				return false;
	...
	public String toString() {
		return "TitleTranslated_ [ca=" + ca + ", en=" + en + ", es=" + es + "]";
	}
