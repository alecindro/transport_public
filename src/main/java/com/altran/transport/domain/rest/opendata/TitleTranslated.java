...
public class TitleTranslated implements Serializable
{
    ...
    private final static long serialVersionUID = 8162740821015505769L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TitleTranslated other = (TitleTranslated) obj;
		if (ca == null) {
			if (other.ca != null)
				return false;
	...
	public String toString() {
		return "TitleTranslated [ca=" + ca + ", en=" + en + ", es=" + es + "]";
	}
