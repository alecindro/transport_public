...
public class NotesTranslated implements Serializable
{
    ...
    private final static long serialVersionUID = 1601094157258383458L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NotesTranslated other = (NotesTranslated) obj;
		if (ca == null) {
			if (other.ca != null)
				return false;
	...
	public String toString() {
		return "NotesTranslated [ca=" + ca + ", en=" + en + ", es=" + es + ", additionalProperties="
