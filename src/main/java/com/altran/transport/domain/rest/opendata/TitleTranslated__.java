...
public class TitleTranslated__ implements Serializable
{
    ...
    private final static long serialVersionUID = -6846781456457048948L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TitleTranslated__ other = (TitleTranslated__) obj;
		if (ca == null) {
			if (other.ca != null)
				return false;
	...
	public String toString() {
		return "TitleTranslated__ [ca=" + ca + ", en=" + en + ", es=" + es + "]";
	}
